...
client = MongoClient("mongodb+srv://kaushikkadari321:8E5Do3DwMC6FCTas@cluster0.yxjavbe.mongodb.net/")
db = client["Nmcg"]
...
def response(user_response):
    ...
    # .replace(user_response,"")
        ...
        y = x + user_response + ", " + response_parapharase.text[:-1].replace(".",",")+". "
...
# print(response("what is the motive of nmcg"))
